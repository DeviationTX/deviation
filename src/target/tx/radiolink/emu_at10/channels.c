...
s32 CHAN_ReadInput(int channel)
{
    ...
    switch (channel) {
        ...
        case INP_AUX4:     return CHAN_MIN_VALUE + step * gui.aux2;
        case INP_AUX5:     return CHAN_MIN_VALUE + step * gui.aux3;
        case INP_AUX6:     return CHAN_MIN_VALUE + step * gui.aux4;
        case INP_AUX7:     return CHAN_MIN_VALUE + step * gui.aux5;
        case INP_AUX8:     return CHAN_MIN_VALUE + step * gui.aux6;
