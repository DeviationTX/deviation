...
#ifndef __HID_USB_ISTR_H
#define __HID_USB_ISTR_H
...
void HID_EP2_IN_Callback(void);
void HID_EP3_IN_Callback(void);
void HID_EP4_IN_Callback(void);
void HID_EP5_IN_Callback(void);
void HID_EP6_IN_Callback(void);
void HID_EP7_IN_Callback(void);

void HID_EP1_OUT_Callback(void);
void HID_EP2_OUT_Callback(void);
void HID_EP3_OUT_Callback(void);
void HID_EP4_OUT_Callback(void);
void HID_EP5_OUT_Callback(void);
void HID_EP6_OUT_Callback(void);
void HID_EP7_OUT_Callback(void);
