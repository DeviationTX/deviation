...
s16 CHAN_ReadInput(int channel)
{
    ...
    switch(channel) {
        ...
        case INP_RUD_DR0:  return gui.rud_dr == 0  ? CHAN_MAX_VALUE : CHAN_MIN_VALUE;
        case INP_RUD_DR1:  return gui.rud_dr == 1  ? CHAN_MAX_VALUE : CHAN_MIN_VALUE;
        case INP_RUD_DR2:  return gui.rud_dr == 2  ? CHAN_MAX_VALUE : CHAN_MIN_VALUE;

        case INP_ELE_DR0:  return gui.ele_dr == 0  ? CHAN_MAX_VALUE : CHAN_MIN_VALUE;
        case INP_ELE_DR1:  return gui.ele_dr == 1  ? CHAN_MAX_VALUE : CHAN_MIN_VALUE;
        case INP_ELE_DR2:  return gui.ele_dr == 2  ? CHAN_MAX_VALUE : CHAN_MIN_VALUE;

        case INP_AIL_DR0:  return gui.ail_dr == 0  ? CHAN_MAX_VALUE : CHAN_MIN_VALUE;
        case INP_AIL_DR1:  return gui.ail_dr == 1  ? CHAN_MAX_VALUE : CHAN_MIN_VALUE;
        case INP_AIL_DR2:  return gui.ail_dr == 2  ? CHAN_MAX_VALUE : CHAN_MIN_VALUE;
