...
s32 CHAN_ReadInput(int channel)
{
    ...
    switch(channel) {
        ...
        case INP_HOLD0:    return (gui.hold % 2)   ? CHAN_MIN_VALUE : CHAN_MAX_VALUE;
        case INP_HOLD1:    return (gui.hold % 2)   ? CHAN_MAX_VALUE : CHAN_MIN_VALUE;

        case INP_TRN0:     return (gui.trn % 2)    ? CHAN_MIN_VALUE : CHAN_MAX_VALUE;
        case INP_TRN1:     return (gui.trn % 2)    ? CHAN_MAX_VALUE : CHAN_MIN_VALUE;
