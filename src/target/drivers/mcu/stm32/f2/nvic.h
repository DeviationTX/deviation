#ifndef _DTX_STM32F2_NVIC_H_
#define _DTX_STM32F2_NVIC_H_

// Why doesn't libopencm3 do this for us
#define NVIC_TIM6_IRQ     NVIC_TIM6_DAC_IRQ
...
static inline uint32_t get_nvic_dma_irq(struct dma_config dma)
{
    ...
    switch (dma.dma) {
        case DMA1:
            switch (dma.stream) {
                case DMA_STREAM0: irq = NVIC_DMA1_STREAM0_IRQ; break;
                case DMA_STREAM1: irq = NVIC_DMA1_STREAM1_IRQ; break;
                case DMA_STREAM2: irq = NVIC_DMA1_STREAM2_IRQ; break;
                case DMA_STREAM3: irq = NVIC_DMA1_STREAM3_IRQ; break;
                case DMA_STREAM4: irq = NVIC_DMA1_STREAM4_IRQ; break;
                case DMA_STREAM5: irq = NVIC_DMA1_STREAM5_IRQ; break;
                case DMA_STREAM6: irq = NVIC_DMA1_STREAM6_IRQ; break;
                case DMA_STREAM7: irq = NVIC_DMA1_STREAM7_IRQ; break;
            }
            break;
        case DMA2:
            switch (dma.stream) {
                case DMA_STREAM0: irq = NVIC_DMA2_STREAM0_IRQ; break;
                case DMA_STREAM1: irq = NVIC_DMA2_STREAM1_IRQ; break;
                case DMA_STREAM2: irq = NVIC_DMA2_STREAM2_IRQ; break;
                case DMA_STREAM3: irq = NVIC_DMA2_STREAM3_IRQ; break;
                case DMA_STREAM4: irq = NVIC_DMA2_STREAM4_IRQ; break;
                case DMA_STREAM5: irq = NVIC_DMA2_STREAM5_IRQ; break;
                case DMA_STREAM6: irq = NVIC_DMA2_STREAM6_IRQ; break;
                case DMA_STREAM7: irq = NVIC_DMA2_STREAM7_IRQ; break;
            }
            break;
    }
    return irq;
