/** @defgroup STM32F2xx_adc_defines ADC Defines

@brief <b>Defined Constants and Types for the STM32F2xx Analog to Digital Converters</b>
...
#define ADC_SMPR1_SMP18_MSK		(0x7 << ADC_SMP18_LSB)
