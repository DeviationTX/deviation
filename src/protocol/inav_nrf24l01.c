...
static void build_data_packet(void)
{
    ...
    if (payload_size == INAV_PROTOCOL_PAYLOAD_SIZE_MIN) {
        // small payload variant of protocol, supports 6 channels
        packet[7] = convert_channel8(CHANNEL5);
        packet[1] = convert_channel8(CHANNEL6);
        return;
    }
...
void transmit_packet(void)
{
    ...
    NRF24L01_WriteReg(NRF24L01_00_CONFIG, BV(NRF24L01_00_PWR_UP) | BV(NRF24L01_00_CRCO) | BV(NRF24L01_00_EN_CRC) | BV(NRF24L01_00_MASK_TX_DS));
...
static void init_nrf24l01(void)
{
    ...
    NRF24L01_SetTxRxMode(TX_EN); // enter transmit mode
    ...
    NRF24L01_WriteReg(NRF24L01_04_SETUP_RETR, NRF24L01_04_ARD_2500us | NRF24L01_04_ARC_1); // one retry after 2500us
    ...
    // Payload Widths for P1-P5 (registers 12 to 16) aret left at default values
    // NRF24L01_17_FIFO_STATUS is read only register for all non-reserved bits
    // No registers with values 18 to 1B
#ifdef USE_AUTO_ACKKNOWLEDGEMENT
    NRF24L01_ReadReg(NRF24L01_1D_FEATURE);
    NRF24L01_Activate(0x73); // Activate feature register, needed for NRF24L01 (harmless for NRF24L01P)
    NRF24L01_ReadReg(NRF24L01_1D_FEATURE);
