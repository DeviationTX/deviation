...
{           
    switch(telem) {
        ...
        case TELEM_DSM_FLOG_VOLT1:      return 800; //do not fit to Devo7e
#else
        case TELEM_DSM_FLOG_HOLDS:
        case TELEM_DSM_FLOG_TEMP1:
        case TELEM_DSM_FLOG_VOLT1:      return 999;
#endif
...
{           
    switch(telem) {
        ...
        case TELEM_DSM_GFORCE_YMAX:
        case TELEM_DSM_GFORCE_ZMAX:
        case TELEM_DSM_GFORCE_ZMIN:     return -4000; //do not fit to Devo7e
#endif
#if HAS_EXTENDED_TELEMETRY
        case TELEM_DSM_FPCAP_AMPS:      return -1400;
        case TELEM_DSM_RXPCAP_AMPS:     return -1800;
