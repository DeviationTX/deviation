    ...
    if (alarm_state[k]==1 && current_time >= music_time) {
        ...
        if (TELEMETRY_Type() == TELEM_DEVO) {
            switch(Model.telem_alarm[k]) {
                ...
                case TELEM_DEVO_VOLT3: MUSIC_PlayValue(MUSIC_GetTelemetryAlarm(MUSIC_TELEMALARM1 + k), (u32)TELEMETRY_GetValue(Model.telem_alarm[k]),TELEM_UNIT_VOLT,2); break;
                case TELEM_DEVO_RPM1:
                case TELEM_DEVO_RPM2: MUSIC_PlayValue(MUSIC_GetTelemetryAlarm(MUSIC_TELEMALARM1 + k), (u32)TELEMETRY_GetValue(Model.telem_alarm[k]),TELEM_UNIT_RPM,0); break;
                default: MUSIC_PlayValue(MUSIC_GetTelemetryAlarm(MUSIC_TELEMALARM1 + k), (u32)TELEMETRY_GetValue(Model.telem_alarm[k])-20,TELEM_UNIT_TEMP,0); break;
            }
        }
        if (TELEMETRY_Type() == TELEM_DSM) {
            switch(Model.telem_alarm[k]) {
...
#endif
                case TELEM_DSM_FLOG_RPM1: MUSIC_PlayValue(MUSIC_GetTelemetryAlarm(MUSIC_TELEMALARM1 + k), (u32)TELEMETRY_GetValue(Model.telem_alarm[k]),TELEM_UNIT_RPM,0); break;
#if HAS_EXTENDED_TELEMETRY
                ...
                case TELEM_DSM_FLOG_VOLT2: MUSIC_PlayValue(MUSIC_GetTelemetryAlarm(MUSIC_TELEMALARM1 + k), (u32)TELEMETRY_GetValue(Model.telem_alarm[k]),TELEM_UNIT_VOLT,2); break;
#if HAS_EXTENDED_TELEMETRY
                case TELEM_DSM_JETCAT_TEMPEGT:
                case TELEM_DSM_ESC_TEMP1:
                case TELEM_DSM_ESC_TEMP2:
#endif
                case TELEM_DSM_FLOG_TEMP1: MUSIC_PlayValue(MUSIC_GetTelemetryAlarm(MUSIC_TELEMALARM1 + k), (u32)TELEMETRY_GetValue(Model.telem_alarm[k]),TELEM_UNIT_TEMP,0); break;
#if HAS_EXTENDED_TELEMETRY
...
#endif
                case TELEM_DSM_AMPS1: MUSIC_PlayValue(MUSIC_GetTelemetryAlarm(MUSIC_TELEMALARM1 + k), (u32)TELEMETRY_GetValue(Model.telem_alarm[k]),TELEM_UNIT_AMPS,2); break;
                ...
                case TELEM_DSM_VARIO_ALTITUDE: MUSIC_PlayValue(MUSIC_GetTelemetryAlarm(MUSIC_TELEMALARM1 + k), (u32)TELEMETRY_GetValue(Model.telem_alarm[k]),TELEM_UNIT_ALTITUDE,2); break;
                ...
                case TELEM_DSM_GFORCE_ZMIN: MUSIC_PlayValue(MUSIC_GetTelemetryAlarm(MUSIC_TELEMALARM1 + k), (u32)TELEMETRY_GetValue(Model.telem_alarm[k]),TELEM_UNIT_GFORCE,2); break;
                default: MUSIC_PlayValue(MUSIC_GetTelemetryAlarm(MUSIC_TELEMALARM1 + k), (u32)TELEMETRY_GetValue(Model.telem_alarm[k]),TELEM_UNIT_NONE,0);
          }
        }
        ...
        if (TELEMETRY_Type() == TELEM_FRSKY) {
            switch(Model.telem_alarm[k]) {
                ...
                case TELEM_FRSKY_VOLT2: MUSIC_PlayValue(MUSIC_GetTelemetryAlarm(MUSIC_TELEMALARM1 + k), (u32)TELEMETRY_GetValue(Model.telem_alarm[k]),TELEM_UNIT_VOLT,2); break;
#if HAS_EXTENDED_TELEMETRY
                case TELEM_FRSKY_TEMP1:
                case TELEM_FRSKY_TEMP2: MUSIC_PlayValue(MUSIC_GetTelemetryAlarm(MUSIC_TELEMALARM1 + k), (u32)TELEMETRY_GetValue(Model.telem_alarm[k])-20,TELEM_UNIT_TEMP,0); break;
                case TELEM_FRSKY_RPM: MUSIC_PlayValue(MUSIC_GetTelemetryAlarm(MUSIC_TELEMALARM1 + k), (u32)TELEMETRY_GetValue(Model.telem_alarm[k]),TELEM_UNIT_RPM,0); break;
                case TELEM_FRSKY_CURRENT: MUSIC_PlayValue(MUSIC_GetTelemetryAlarm(MUSIC_TELEMALARM1 + k), (u32)TELEMETRY_GetValue(Model.telem_alarm[k]),TELEM_UNIT_AMPS,2); break;
                case TELEM_FRSKY_ALTITUDE: MUSIC_PlayValue(MUSIC_GetTelemetryAlarm(MUSIC_TELEMALARM1 + k), (u32)TELEMETRY_GetValue(Model.telem_alarm[k]),TELEM_UNIT_ALTITUDE,2); break;
#endif
                default: MUSIC_PlayValue(MUSIC_GetTelemetryAlarm(MUSIC_TELEMALARM1 + k), (u32)TELEMETRY_GetValue(Model.telem_alarm[k]),TELEM_UNIT_NONE,0);
            }
        }
