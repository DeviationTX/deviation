...
static void _show_page()
{
    ...
    if (page_num == 0) {
        ...
        GUI_CreateTextSelect(&gui1->mode, 112, row, TEXTSELECT_96, 0x0000, NULL, modeselect_cb, NULL);
        row += space + 8;
        ...
        GUI_CreateTextSelect(&gui1->battalrm, 112, row, TEXTSELECT_96, 0x0000, NULL, batalarm_select_cb, NULL);
        row += space;
        ...
        GUI_CreateTextSelect(&gui1->buzz, 112, row, TEXTSELECT_96, 0x0000, NULL, common_select_cb, (void *)&Transmitter.volume);
        ...
        GUI_CreateTextSelect(&gui2->backlight, 112, row, TEXTSELECT_96, 0x0000, NULL, brightness_select_cb, NULL);
        row += space;
        GUI_CreateLabelBox(&gui2->dimtimelbl, 16, row, 0, 0, &DEFAULT_FONT, NULL, NULL, _tr("Dimmer time:"));
        GUI_CreateTextSelect(&gui2->dimtime, 112, row, TEXTSELECT_96, 0x0000, NULL, auto_dimmer_time_cb, NULL);
        row += space;
        GUI_CreateLabelBox(&gui2->dimtgtlbl, 16, row, 0, 0, &DEFAULT_FONT, NULL, NULL, _tr("Dimmer target:"));
        GUI_CreateTextSelect(&gui2->dimtgt, 112, row, TEXTSELECT_96, 0x0000, NULL, common_select_cb,
        ...
        GUI_CreateTextSelect(&gui2->temp, 112, row, TEXTSELECT_96, 0x0000, NULL, units_cb, (void *)1L);
        row += space;
        GUI_CreateLabelBox(&gui2->lengthlbl, 16, row, 0, 0, &DEFAULT_FONT, NULL, NULL, _tr("Length:"));
        GUI_CreateTextSelect(&gui2->length, 112, row, TEXTSELECT_96, 0x0000, NULL, units_cb, (void *)0L);
    } else if (page_num == 2) {
        ...
        GUI_CreateTextSelect(&gui3->prealert, 130, row, TEXTSELECT_96, 0x0000,NULL, prealert_time_cb, (void *)0L);
        row += space;
        GUI_CreateLabelBox(&gui3->preintvllbl, 16, row, 0, 0, &DEFAULT_FONT, NULL, NULL, _tr("Prealert intvl:"));
        GUI_CreateTextSelect(&gui3->preintvl, 130, row, TEXTSELECT_96, 0x0000, NULL, timer_interval_cb,
        ...
        GUI_CreateTextSelect(&gui3->timeup, 130, row, TEXTSELECT_96, 0x0000, NULL, timer_interval_cb,
